 ...
 *
 **/
func (obj *BlobHandler) AddOnDeleteRequest(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler) error) {
	obj.onEvent.OnDeleteRequestList = append(obj.onEvent.OnDeleteRequestList, f)
}

func (obj *BlobHandler) AddOnDeleteFailed(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler, *miniblob.BlobItem)) {
	obj.onEvent.OnDeleteFailedList = append(obj.onEvent.OnDeleteFailedList, f)
}

func (obj *BlobHandler) AddOnDeleteSuccess(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler, *miniblob.BlobItem)) {
	obj.onEvent.OnDeleteSuccessList = append(obj.onEvent.OnDeleteSuccessList, f)
}

func (obj *BlobHandler) OnDeleteRequest(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler) error {
...
func (obj *BlobHandler) OnDeleteFailed(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler, i *miniblob.BlobItem) {
	for _, f := range obj.onEvent.OnDeleteFailedList {
		f(w, r, o, h, i)
	}
}

func (obj *BlobHandler) OnDeleteSuccess(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler, i *miniblob.BlobItem) {
 ...
 *
 **/
func (obj *BlobHandler) AddOnGetRequest(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler) error) {
	obj.onEvent.OnGetRequestList = append(obj.onEvent.OnGetRequestList, f)
}

func (obj *BlobHandler) AddOnGetFailed(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler, *miniblob.BlobItem)) {
	obj.onEvent.OnGetFailedList = append(obj.onEvent.OnGetFailedList, f)
}

func (obj *BlobHandler) AddOnGetSuccess(f func(http.ResponseWriter, *http.Request, *mm.MiniProp, *BlobHandler, *miniblob.BlobItem)) {
	obj.onEvent.OnGetSuccessList = append(obj.onEvent.OnGetSuccessList, f)
}

func (obj *BlobHandler) OnGetRequest(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler) error {
...
func (obj *BlobHandler) OnGetFailed(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler, i *miniblob.BlobItem) {
	for _, f := range obj.onEvent.OnGetFailedList {
		f(w, r, o, h, i)
	}
}

func (obj *BlobHandler) OnGetSuccess(w http.ResponseWriter, r *http.Request, o *mm.MiniProp, h *BlobHandler, i *miniblob.BlobItem) {
